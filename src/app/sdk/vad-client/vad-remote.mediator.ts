...
export const AI_VAD_HTTP_CLIENT: IToken<HttpClient> = createToken<HttpClient>('AI_VAD_HTTP_CLIENT');
export const AI_VAD_REMOTE_CONFIG: IToken<{ baseUrl: string }> = createToken<{ baseUrl: string }>('AI_VAD_REMOTE_CONFIG');
