...
export const AI_CONVERSATION_HTTP_CLIENT: IToken<HttpClient> = createToken<HttpClient>('AI_CONVERSATION_HTTP_CLIENT');

/** Internal token for the remote conversation service config. */
export const AI_CONVERSATION_REMOTE_CONFIG: IToken<{ baseUrl: string }> = createToken<{ baseUrl: string }>(
