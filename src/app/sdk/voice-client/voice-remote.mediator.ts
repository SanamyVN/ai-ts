...
export const AI_VOICE_HTTP_CLIENT: IToken<HttpClient> = createToken<HttpClient>('AI_VOICE_HTTP_CLIENT');
export const AI_VOICE_REMOTE_CONFIG: IToken<{ baseUrl: string }> = createToken<{ baseUrl: string }>('AI_VOICE_REMOTE_CONFIG');
